...
/**
 * A {@link View.OnTouchListener} that makes the list items in a {@link ListView} dismissable. {@link ListView} is given special treatment because by default it handles touches for
 * its list items... i.e. it's in charge of drawing the pressed state (the list selector), handling list item clicks, etc.
 * 
 * <p>
 * After creating the listener, the caller should also call {@link ListView#setOnScrollListener(AbsListView.OnScrollListener)}, passing in the scroll listener returned by
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
	...
	/**
	 * Returns an {@link AbsListView.OnScrollListener} to be added to the {@link ListView} using {@link ListView#setOnScrollListener(AbsListView.OnScrollListener)}. If a scroll
	 * listener is already assigned, the caller should still pass scroll changes through to this listener. This will ensure that this {@link SwipeDismissListViewTouchListener} is
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_UP: {
			...
			ULog.i(this, "onTouch()  !!!!!!!!!!!!!!!!!!!!! + action up, tvJP2:"  + view.findViewById(R.id.tvJP2).getTag() +"; llWord:"+ view.findViewById(R.id.llWord).getTag() +"; view id:" + view.getId());
			if (mVelocityTracker == null) {
				moveMouse = 0;
				break;
			}
			...
			// ///for item click
			if (moveMouse < 3)
				mCallbacks.onClickItem(mDownView, mDownPosition);
			moveMouse = 0;
			// ///
		...
		animator.addListener(new AnimatorListenerAdapter() {
			...
			public void onAnimationEnd(Animator animation) {
				...
				if (mDismissAnimationRefCount == 0) {
					ULog.i(SwipeDismissListViewTouchListener.this, "onAnimationEnd() ");
