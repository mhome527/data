...
public class GMapV2Direction {
	...
	public String getDurationText(Document doc) {
		...
		ULog.i("DurationText", node2.getTextContent());
	...
	public int getDurationValue(Document doc) {
		...
		ULog.i("DurationValue", node2.getTextContent());
	...
	public String getDistanceText(Document doc) {
		...
		NodeList nl2 = node1.getChildNodes();
		Node node2 = nl2.item(getNodeIndex(nl2, "text"));
		ULog.i("DistanceText", node2.getTextContent());
		return node2.getTextContent();
	}
	...
	public int getDistanceValue(Document doc) {
		...
		NodeList nl2 = node1.getChildNodes();
		Node node2 = nl2.item(getNodeIndex(nl2, "value"));
		ULog.i("DistanceValue", node2.getTextContent());
		return Integer.parseInt(node2.getTextContent());
	}
	...
	public String getStartAddress(Document doc) {
		...
		ULog.i("StartAddress", node1.getTextContent());
	...
	public String getCopyRights(Document doc) {
		...
		Node node1 = nl1.item(0);
		ULog.i("CopyRights", node1.getTextContent());
		return node1.getTextContent();
	}
